if 1:
    ...
    """
        ...
        print(variables = 1       # this function only handles one measured variable)
...
###
        print(title = [['FACTORS: '),'RANDOM'] + effects[:Nfactors]]
        ...
        pstat.printcc(title)
        print(title = [['Effect'),'SS','DF','MS','F','p','sig']] + ['dashes']
