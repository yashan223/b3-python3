...
class Client(object):
    ...
    def tempban(self, reason='', keyword=None, duration=2, admin=None, silent=False, data='', *kwargs):
        ...
        :param silent: Whether or not to announce this tempban        :param data: Extra data to add to the penalty
        """
    ...
    def warn(self, duration, warning, keyword=None, admin=None, data=''):
        """
        Warn this client.        :param duration: The duration of this warning
...
class Penalty(Struct):
    ...
    def _set_duration(self, v):        self._duration = b3.functions.time2minutes(v)
...
class Clients(dict):
    ...
    def __init__(self, console):
        ...
        # Python 2/3 compatibility for unichr
        try:
            unichr = unichr
        except NameError:
            unichr = chr
